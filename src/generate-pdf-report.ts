...
var printer = new PdfPrinter({
  ...
  NunitoSans: {
    normal: path.join(
      __dirname,
      "..",
      "/fonts/NunitoSans/NunitoSans-Regular.ttf"
    ),
    bold: path.join(__dirname, "..", "/fonts/NunitoSans/NunitoSans-Bold.ttf"),
    italics: path.join(
      __dirname,
      "..",
      "/fonts/NunitoSans/NunitoSans-Italic.ttf"
    ),
    bolditalics: path.join(
      __dirname,
      "..",
      "/fonts/NunitoSans/NunitoSans-BoldItalic.ttf"
    ),
  },
  CommutersSans: {
    normal: path.join(
      __dirname,
      "..",
      "/fonts/CommutersSans/CommutersSans-Regular.ttf"
    ),
    bold: path.join(
      __dirname,
      "..",
      "/fonts/CommutersSans/CommutersSans-Bold.ttf"
    ),
    italics: path.join(
      __dirname,
      "..",
      "/fonts/CommutersSans/CommutersSans-Italic.ttf"
    ),
    bolditalics: path.join(
      __dirname,
      "..",
      "/fonts/CommutersSans/CommutersSans-BoldItalic.ttf"
    ),
  },
});
...
router.post("/", async function (req: express.Request, res: express.Response) {
  try {
    ...
    var bg: Bodygraph = bodygraph.createBodygraph(
      req.body.name,
      date,
      req.body.location || "London, United Kingdom"
    );
    ...
    function getDetermination(bg: Bodygraph) {
      let type: string =
        bg.activations.Design.Sun.Tone < 4
          ? determinations.leftVariableVariants[bg.activations.Design.Sun.Color]
          : determinations.rightVariableVariants[
              bg.activations.Design.Sun.Color
            ];
    ...
    function getEnvironment(bg: Bodygraph) {
      let type: string =
        bg.activations.Design.Sun.Tone < 4
          ? environments.leftVariableVariants[
              bg.activations.Design.SouthNode.Color
            ]
          : environments.rightVariableVariants[
              bg.activations.Design.SouthNode.Color
            ];
    ...
    function getFormattedChannels(bg: Bodygraph) {
      ...
      for (let i = 0; i < bg.channels.length; i++) {
        formattedChannels += `${channels.names[bg.channels[i]]} (${
          bg.channels[i]
        })`;
    ...
    var docDefinition = {
      content: [
        ...
        { image: "./images/page-1-bodygraph.png", width: 516 },
        {
          ...
          columns: [
            ...
            {
              text: `${bg.birthDateAndTime}\n${bg.location}\n${bg.profile} ${bg.authority} ${bg.type}`,
              pageBreak: "after",
            },
          ],
        },
        ...
        {
          text: pageText.page_2_about_this_hd_differentiation_guide,
          style: "subheader",
          margin: [0, 0, 0, 13],
        },
        {
          columns: [
            ...
            {
              text: pageText.page_2_right_column,
              style: "rightColumn",
              pageBreak: "after",
            },
          ],
          ...
          columns: [
            {
              text: [
                {
                  text: pageText.page_3_quick_breakdown,
                  style: "subheader",
                  margin: [0, 0, 0, 13],
                  lineHeight: 0.5,
                },
            ...
            {
              text: pageText.page_3_right_column,
              style: "rightColumn",
              pageBreak: "after",
            },
          ],
        ...
        // Page 4 --- Profile, Energy Type, Authority, Strategy, Definition, Signature etc
        {
          ...
          table: {
            ...
            body: [
              ...
              [
                { text: "ENERGY TYPE:", style: "greyTableLabel" },
                getFormattedEnergyType(bg),
              ],
              [{ text: "AUTHORITY:", style: "greyTableLabel" }, bg.authority],
              [
                { text: "INNER AUTHORITY:", style: "greyTableLabel" },
                bg.authority,
              ],
              [
                { text: "OUTER AUTHORITY:", style: "greyTableLabel" },
                bg.outerAuthority,
              ],
              [
                { text: "STRATEGY", style: "greyTableLabel" },
                strategies[bg.type],
              ],
              [{ text: "DEFINITION:", style: "greyTableLabel" }, bg.definition],
              [
                { text: "SIGNATURE:", style: "greyTableLabel" },
                signatures[bg.type],
              ],
              [
                { text: "NOT SELF THEME:", style: "greyTableLabel" },
                notSelfThemes.types[bg.type],
              ],
              [
                { text: "INCARNATION CROSS:", style: "greyTableLabel" },
                "Right Angle Cross of Eden\nPersonality Sun (12) Personality Earth (11)\nDesign Sun (36) Design Earth (6)",
              ],
              [
                { text: "DETERMINATION:", style: "greyTableLabel" },
                getDetermination(bg),
              ],
              [
                { text: "ENVIRONMENT:", style: "greyTableLabel" },
                getEnvironment(bg),
              ],
              [
                { text: "MOTIVATION:", style: "greyTableLabel" },
                motivations[bg.activations.Personality.Sun.Color],
              ],
              [
                { text: "VIEW:", style: "greyTableLabel" },
                views[bg.activations.Personality.NorthNode.Color],
              ],
              [
                { text: "COGNITIVE TONE:", style: "greyTableLabel" },
                cognitiveTones[bg.activations.Design.Sun.Tone],
              ],
              [
                { text: "ENVIRONMENTAL TONE:", style: "greyTableLabel" },
                environmentalTones[bg.activations.Design.SouthNode.Tone],
              ],
              [
                { text: "TRANSFERENCE:", style: "greyTableLabel" },
                transferences[bg.activations.Personality.Sun.Color],
              ],
              [
                { text: "DISTRACTION:", style: "greyTableLabel" },
                distractions[bg.activations.Personality.NorthNode.Color],
              ],
              [
                { text: "CIRCUITRY:", style: "greyTableLabel" },
                getFormattedCircuitries(bg),
              ],
              ...
              text: [
                {
                  text: `${
                    bg.profile
                  } ${bg.authority.toUpperCase()} ${bg.type.toUpperCase()}\n\nPERSONALITY SUN GATE:\n`,
                  style: "columnLabel",
                },
              ...
              text: [
                {
                  ...
                  text: "NOT SELF THEME: FRUSTRATION",
                },
                "\nLorem ipsum dolor sit amet, consectetuer adipisc- ing elit, sed diam nonummy nibh euismod tincid- unt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto",
              ], // End text array
              style: "rightColumn",
      ...
      styles: {
        ...
        supheader: {
          // For headers *above* the main header
          fontSize: 11,
    ...
    var astroDetail = [
      ...
      { text: "STRATEGY:", data: strategies[bg.type] },
      ...
      {
        text: "COGNITIVE TONE:",
        data: cognitiveTones[bg.activations.Design.Sun.Tone],
      },
      { text: "ENVIRONMENT:", data: getEnvironment(bg) },
      {
        text: "VIEW/PERSPECTIVE:",
        data: views[bg.activations.Personality.NorthNode.Color],
      },
      {
        text: "MOTIVATION:",
        data: motivations[bg.activations.Personality.Sun.Color],
      },
      { text: "SIGNATURE:", data: signatures[bg.type] },
      { text: "NOT SELF THEME:", data: notSelfThemes.types[bg.type] },
      // { text: 'INCARNATION CROSS:', data: 'Right Angle Cross of Eden\nPersonality Sun (12) Personality Earth (11)\nDesign Sun (36) Design Earth (6)' },
      {
        text: "ENVIRONMENTAL TONE:",
        data: environmentalTones[bg.activations.Design.SouthNode.Tone],
      },
      {
        text: "TRANSFERENCE:",
        data: transferences[bg.activations.Personality.Sun.Color],
      },
      {
        text: "DISTRACTION:",
        data: distractions[bg.activations.Personality.NorthNode.Color],
      },
    ...
    if (bg) {
      ...
      let finalData: any = [];
      if (bg.activatedPersonalityGates.length > 0) {
        for (let i = 0; i < bg.activatedPersonalityGates.length; i++) {
          let designGates: any = [];

          bg.activatedDesignGates.forEach((element, key) => {
            if (element == bg.activatedPersonalityGates[i]) {
              designGates.push(key);
            }
          });

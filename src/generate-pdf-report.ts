...
router.post("/", async function (req: express.Request, res: express.Response) {
	try {
		...
		var astroDetail = [
			...
			{ text: 'COGNITIVE TONE:', data: cognitiveTones[bg.activations.Design.Sun.Tone] },
			{ text: 'ENVIRONMENT:', data: getEnvironment(bg) },
			{ text: 'VIEW/PERSPECTIVE:', data: views[bg.activations.Personality.NorthNode.Color] },
			{ text: 'MOTIVATION:', data: motivations[bg.activations.Personality.Sun.Color] },
			...
			{ text: 'ENVIRONMENTAL TONE:', data: environmentalTones[bg.activations.Design.SouthNode.Tone] },
			{ text: 'TRANSFERENCE:', data: transferences[bg.activations.Personality.Sun.Color] },
			{ text: 'DISTRACTION:', data: distractions[bg.activations.Personality.NorthNode.Color] },
